...
<section class="section">
  ...
  <div class="cards subjects">
    {#each [['DSA I', 'Arrays, lists, stacks, sorting and searching', '/learn/dsa-1', 'Live'], ['DSA II', 'Trees, graphs, heaps and dynamic programming', '/learn/dsa-2', 'BFS live'], ['DBMS', 'Trace joins, filters, grouping and transactions', '/learn/dbms', 'Pipeline live'], ['Operating Systems', 'Processes, scheduling, pages and locks', '/learn/operating-systems', 'Foundation'], ['Networks', 'Packets, protocols, DNS and TCP', '/learn/computer-networks', 'Foundation']] as s}<a
        class="card panel"
        href={s[2]}
